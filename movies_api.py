...
def movie_list():
    ...
    # Ð¢ÑƒÑ‚ ÑƒÐ¶Ðµ Ð²Ð°Ð»Ð¸Ð´Ð½Ð¾ Ð²ÑÐµ
    for param in request.args.keys():
        defaults[param] = request.args.get(param)

    # Ð£Ñ…Ð¾Ð´Ð¸Ñ‚ Ð² Ñ‚ÐµÐ»Ð¾ Ð·Ð°Ð¿Ñ€Ð¾ÑÐ°. Ð•ÑÐ»Ð¸ Ð·Ð°Ð¿Ñ€Ð¾Ñ Ð½Ðµ Ð¿ÑƒÑÑ‚Ð¾Ð¹ - Ð¼ÑƒÐ»ÑŒÑ‚Ð¸ÑÐµÑ€Ñ‡, ÐµÑÐ»Ð¸ Ð¿ÑƒÑÑ‚Ð¾Ð¹ - Ð²Ñ‹Ð´Ð°ÐµÑ‚ Ð²ÑÐµ Ñ„Ð¸Ð»ÑŒÐ¼Ñ‹
    body = {
        "query": {
            "multi_match": {
