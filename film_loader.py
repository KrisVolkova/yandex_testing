...
def extract():
    ...
    # ÐÐ°Ð²ÐµÑ€Ð½ÑÐºÐ° ÑÑ‚Ð¾ Ð¿Ð¸Ð»Ð¸Ñ‚ÑÑ Ð² Ð¾Ð´Ð¸Ð½ sql - Ð·Ð°Ð¿Ñ€Ð¾Ñ, Ð½Ð¾ Ð¼Ð½Ðµ ÐºÐ°Ðº-Ñ‚Ð¾ Ð»ÐµÐ½Ð¸Ð²Ð¾)

    # ÐŸÐ¾Ð»ÑƒÑ‡Ð°ÐµÐ¼ Ð²ÑÐµ Ð¿Ð¾Ð»Ñ Ð´Ð»Ñ Ð¸Ð½Ð´ÐµÐºÑÐ°, ÐºÑ€Ð¾Ð¼Ðµ ÑÐ¿Ð¸ÑÐºÐ° Ð°ÐºÑ‚ÐµÑ€Ð¾Ð² Ð¸ ÑÑ†ÐµÐ½Ð°Ñ€Ð¸ÑÑ‚Ð¾Ð², Ð´Ð»Ñ Ð½Ð¸Ñ… Ñ‚Ð¾Ð»ÑŒÐºÐ¾ id
    cursor.execute("""
    ...
    # ÐÑƒÐ¶Ð½Ñ‹ Ð´Ð»Ñ ÑÐ¾Ð¾Ñ‚Ð²ÐµÑ‚ÑÐ²Ð¸Ñ Ð¸Ð´ÐµÐ½Ñ‚Ð¸Ñ„Ð¸ÐºÐ°Ñ‚Ð¾Ñ€Ð° Ð¸ Ñ‡ÐµÐ»Ð¾Ð²ÐµÐºÐ¾Ñ‡Ð¸Ñ‚Ð°ÐµÐ¼Ð¾Ð³Ð¾ Ð½Ð°Ð·Ð²Ð°Ð½Ð¸Ñ
...
def transform(__actors, __writers, __raw_data):
    ...
    for movie_info in __raw_data:
        # Ð Ð°Ð·Ñ‹Ð¼ÐµÐ½Ð¾Ð²Ð°Ð½Ð¸Ðµ ÑÐ¿Ð¸ÑÐºÐ°
